...
const testimonials: Testimonial[] = [
  {
    ...
    image: "/Clients/Rosa Antonini Client 1.jpg",
    quote:
  ...
  },
  {
    ...
    name: "Fraser Briggs",
    role: "Fitness Coach",
    image: "/Clients/Fraser Moves Client 3.png",
    quote:
  ...
  },
  {
    ...
    image: "/Clients/Alex Kahts Client 4.png",
    quote:
  ...
  },
  {
    ...
    image: "/Clients/Idan Nimtso Client 5.png",
    quote:
...
export function TestimonialsSection() {
  ...
  return (
    <section className="relative w-full py-24 px-4 overflow-hidden border-t border-white/5">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="text-center mb-16 flex flex-col items-center">
          {/* Eyebrow */}
          <RevealText>
            <StarBorder as="div" className="mb-6 text-xs tracking-[0.2em] uppercase text-gray-400 hover:text-black transition-colors duration-300" color="rgba(255, 255, 255, 0.2)" speed="4s" style={{ '--content-padding': '0.5rem 1.2rem', '--star-hover-bg': 'linear-gradient(180deg, #F3DFA2 0%, #D4AF37 100%)', '--star-hover-text': 'black', } as React.CSSProperties} > TESTIMONIALS </StarBorder>
          </RevealText>
        ...
        {/* STACK */}
        <div
          className="relative h-[880px] md:h-[560px] max-w-5xl mx-auto"
              ...
              return (
                ...
                >
                  <div className="h-full w-full rounded-2xl bg-[#0a0a0a] border border-white/20 shadow-2xl overflow-hidden flex flex-col group transition-colors duration-300 hover:border-white/40">
                    ...
                    <div className="flex flex-col md:flex-row flex-1 items-center p-8 gap-8">
                      {/* TEXT */}
                      ...
                      {/* IMAGE */}
                      <motion.div
                        className={`relative w-full md:w-[360px] h-[280px] md:h-[320px] rounded-xl overflow-hidden shrink-0 border border-white/20 shadow-lg group-hover:border-white/30 transition-colors duration-300 bg-white/5 ${(t.id === 1 || t.id === 2) ? "bg-black/20" : ""
                          }`}
                      >
                        <Image
                          src={t.image}
